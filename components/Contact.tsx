            ...
            <div className="bg-gradient-to-br from-gray-900 to-black p-8 md:p-12 rounded-2xl border border-gray-800 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-8">
                ...
                <motion.a
                  ...
                  className="flex items-center space-x-4 p-4 rounded-xl bg-black/50 border border-gray-800 hover:border-gray-600 transition-all group"
                >
                ...
                <motion.div
                  whileHover={{ scale: 1.02, x: 10 }}
                  className="flex items-center space-x-4 p-4 rounded-xl bg-black/50 border border-gray-800"
                >
                  <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-3 rounded-lg">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="pt-8 text-center">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="inline-block px-10 py-4 bg-white text-black rounded-full font-semibold text-lg transition-all duration-300 hover:bg-gray-200"
                  >
                    Start Your Project
                  </motion.a>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-400">
                    © 2024 White Wolf Studios. All rights reserved.
                  </span>
                </div>
